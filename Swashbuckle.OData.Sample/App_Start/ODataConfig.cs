...
namespace SwashbuckleODataSample
{
  public static class ODataConfig
  {
    ...
    private static void ConfigureWebApiOData(HttpConfiguration config)
    {
      ...
      config.MapODataServiceRoute("DefaultODataRoute", ODataRoutePrefix, GetToolsModel());
    }

    private static IEdmModel GetToolsModel()
    {
      ...
      // add alternate key
      var edmEntityType = model.FindType("SwashbuckleODataSample.Models.ToolHistory") as IEdmEntityType;
